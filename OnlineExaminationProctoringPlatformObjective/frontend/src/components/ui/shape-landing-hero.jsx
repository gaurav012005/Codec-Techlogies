...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-4 md:px-6 pt-24 md:pt-32">
                <div className="max-w-3xl flex flex-col items-center justify-center mx-auto text-center">
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="flex flex-row gap-4 justify-center items-center w-full mx-auto"
                    >
                        {actionBtns}
                    </motion.div>
                </div>
